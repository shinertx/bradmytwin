...
const prompts: Record<OnboardingState, string> = {
  ...
  ASK_CONNECT_CALENDAR:
    'Nice to meet you. Reply CONNECT CALENDAR to link Google Calendar or SKIP.',
  ASK_CONNECT_EMAIL:
    'Great. Reply CONNECT EMAIL to link Gmail or SKIP.',
...
export function advanceOnboarding(
  ...
  input: string
): { nextState: OnboardingState; response: string } {
